...
SlashCmdList["OTLGMTEST"] = function()
    ...
    PrintLine("Modules=" .. tostring(moduleCount) .. "/29; registry=" .. tostring(registryReady and "ready" or "incomplete") .. "; database=" .. tostring(db and "ready" or "unavailable") .. "; migration=" .. tostring(db and db.migration and db.migration.foundation170 and "1.7" or "pending"))
