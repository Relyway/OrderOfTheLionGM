...
-- Community interaction and achievement-runtime enhancements.
...
local PreviousProgressR4 = OTLGM.__impl180.GetAchievementProgress174__impl2
function OTLGM.__impl180.GetAchievementProgress174__impl3(self, def)
    ...
    return PreviousProgressR4(self, def)
end

local PreviousAddCounterR4 = OTLGM.__impl180.AddAchievementCounter174__impl1

local PreviousSetCounterR4 = OTLGM.__impl180.SetAchievementCounter174__impl1

local PreviousAddSetR4 = OTLGM.__impl180.AddAchievementSetValue174__impl1

local PreviousCommunityReactionR4 = OTLGM.__impl180.SetCommunityReaction__impl1
function OTLGM:SetCommunityReaction(kind, id, reaction, remote)
    local result = PreviousCommunityReactionR4(self, kind, id, reaction, remote)
...
local PreviousBuildAchievementsR4 = OTLGM.__impl180.BuildAchievementsPage174__impl2
function OTLGM.__impl180.BuildAchievementsPage174__impl3(self, page)
    PreviousBuildAchievementsR4(self, page)
    local index, row
...
local PreviousRefreshAchievementsR4 = OTLGM.__impl180.RefreshAchievements174__impl2
...
local PreviousRefreshGuildChatR4 = OTLGM.__impl180.RefreshGuildChatPage__impl1
function OTLGM.__impl180.RefreshGuildChatPage__impl2(self)
    local result = PreviousRefreshGuildChatR4(self)
...
function OTLGM.__impl180.RefreshGuildChatNavigationBadge__impl2(self)
    if not self.ui or not self.ui.navButtons then return end
...
local PreviousBuildActivityR4 = OTLGM.__impl180.BuildActivityPage__impl2
function OTLGM.__impl180.BuildActivityPage__impl3(self, page)
    PreviousBuildActivityR4(self,page)
...
local PreviousRefreshActivityR4 = OTLGM.__impl180.RefreshActivityPage__impl1
function OTLGM.__impl180.RefreshActivityPage__impl2(self)
    PreviousRefreshActivityR4(self)
...
function OTLGM.__impl180.BuildRaidEditor156__impl3(self)
...
local PreviousBuildRaidEnhancementsR4 = OTLGM.__impl180.BuildRaidEnhancements157__impl2
function OTLGM.__impl180.BuildRaidEnhancements157__impl3(self)
    PreviousBuildRaidEnhancementsR4(self)
...
local PreviousRefreshRaidPlannerR4 = OTLGM.__impl180.RefreshRaidPlanner156__impl2
function OTLGM.__impl180.RefreshRaidPlanner156__impl3(self)
    local result = PreviousRefreshRaidPlannerR4(self)
    local detail = self.ui and self.ui.raidSeen156 and self.ui.raidSeen156:GetParent() or nil
    if detail then
        local function Move(frame,x,y,w,h)
            if not frame then return end
...
local PreviousHomeRaidR4 = OTLGM.__impl180.RefreshHomePveSummary155__impl2
function OTLGM.__impl180.RefreshHomePveSummary155__impl3(self)
    PreviousHomeRaidR4(self)
...
function OTLGM.__impl180.RefreshDarkmoonStatusR4__impl1(self)
...
local PreviousBuildHomeR4 = OTLGM.__impl180.BuildHomePage__impl1
function OTLGM.__impl180.BuildHomePage__impl2(self, page)
    PreviousBuildHomeR4(self,page)
...
function OTLGM:BuildPinnedRecruitmentEditorR4()
    ...
    CreateButtonR4(dialog,"Reset Default",24,-258,116,30,function()
        ...
        local preset=PreviousRecruitmentPresetR4(OTLGM,key)
...
local PreviousBuildRecruitmentR4 = OTLGM.__impl180.BuildRecruitmentPage__impl1
function OTLGM.__impl180.BuildRecruitmentPage__impl2(self, page)
    PreviousBuildRecruitmentR4(self,page)
    ...
    for index=1,2 do
        ...
        if row then
            ...
            local captured=key
            -- Main.lua created a generic Edit button before the pinned-message
            -- editor existed. Retire it and expose exactly one canonical editor.
            local legacy = self.ui.presetEditButtons180 and self.ui.presetEditButtons180[key]
            if legacy then legacy:Hide() end
            local edit = CreateButtonR4(row,"Edit",526,-6,76,28,function() OTLGM:OpenPinnedRecruitmentEditorR4(captured) end,"utility")
            self.ui.pinnedRecruitEditButtonsR4[key]=edit
            self.ui.presetEditButtons180[key]=edit
        end
    end
end

local PreviousRefreshRecruitmentR4 = OTLGM.__impl180.RefreshRecruitmentPage__impl1
function OTLGM.__impl180.RefreshRecruitmentPage__impl2(self)
    PreviousRefreshRecruitmentR4(self)
    local key,button
...
function OTLGM.__impl180.UpdateGroupSession174__impl3(self, silent)
    local result = PreviousUpdateGroupSessionR4(self,silent)
    EvaluateThresholdAchievementsR4(self,silent and true or false)
    return result
end

local PreviousRecordGroupApplicationR4 = OTLGM.__impl180.RecordGroupApplication174__impl1
function OTLGM.__impl180.RecordGroupApplication174__impl2(self, group,record)
    local result = PreviousRecordGroupApplicationR4(self,group,record)
    EvaluateThresholdAchievementsR4(self,false)
    return result
end

local PreviousCheckResurrectionR4 = OTLGM.__impl180.CheckResurrection175__impl1
function OTLGM.__impl180.CheckResurrection175__impl2(self)
    local result = PreviousCheckResurrectionR4(self)
